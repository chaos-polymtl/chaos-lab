...
Estimate the allocation cost of a high-performance computing job. Enter the number of cores, the job's wall-clock duration in hours, and the number of jobs to obtain the cost expressed in **core-hours** and **core-years** (using 1 core-year = 8760 core-hours).
...
<div id="hpc-cost-tool" class="tool-card stat-tool">
  <form id="hpc-form" class="calc-form">
    <div class="calc-field">
      ...
      <input type="number" id="hpc-cores" value="192" step="1" min="1" inputmode="numeric">
    </div>
    ...
    <div class="calc-field">
      <label for="hpc-jobs">Number of jobs</label>
      <input type="number" id="hpc-jobs" value="1" step="1" min="1" inputmode="numeric">
    </div>
  </form>
